...
SET counties_represented = CASE district
  ...
  WHEN 3 THEN 'Carroll'
  WHEN 4 THEN 'Coos, Grafton, Strafford'
  WHEN 5 THEN 'Grafton, Merrimack, Sullivan'
  WHEN 6 THEN 'Belknap, Strafford'
  WHEN 7 THEN 'Belknap, Grafton, Hillsborough, Merrimack, Sullivan'
  WHEN 8 THEN 'Cheshire, Hillsborough, Merrimack, Sullivan'
  WHEN 9 THEN 'Cheshire, Hillsborough'
  WHEN 10 THEN 'Cheshire'
