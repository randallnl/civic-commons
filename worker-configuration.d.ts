/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e2f542afc3703a972f05bb40cf108a66)
// Runtime types generated with workerd@1.20260721.1 2026-06-05 global_fetch_strictly_public
interface __BaseEnv_Env {
	"organization-assets": R2Bucket;
	r2_bucket: R2Bucket;
	d1_db: D1Database;
	email_send: SendEmail;
	MONDAY_API_KEY: SecretsStoreSecret;
	BROWSER: BrowserRun;
	ASSETS: Fetcher;
	CONTENT_GENERATOR_BASE_URL: "https://content-generator.randall-d53.workers.dev";
}
