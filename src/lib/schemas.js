...
export const CandidateSchema = z
  .object({
    ...
    nameAliases: optionalStringish,
    name_aliases: optionalStringish,
    ...
    ballotpediaUrl: optionalStringish,
    ballotpedia_url: optionalStringish,
    citizensCountUrl: optionalStringish,
    citizens_count_url: optionalStringish,
    stateHouseProfileUrl: optionalStringish,
    state_house_profile_url: optionalStringish,
    substackUrl: optionalStringish,
    substack_url: optionalStringish,
    instagramUrl: optionalStringish,
    instagram_url: optionalStringish,
    facebookUrl: optionalStringish,
    facebook_url: optionalStringish,
    tiktokUrl: optionalStringish,
    tiktok_url: optionalStringish,
    xUrl: optionalStringish,
    x_url: optionalStringish,
    blueskyUrl: optionalStringish,
    bluesky_url: optionalStringish,
    photoUrl: optionalStringish,
    photo_url: optionalStringish,
    slug: optionalStringish,
    isFreeStateAligned2026: z.unknown().optional(),
    is_free_state_aligned_2026: z.unknown().optional(),
    isTpActionAligned2026: z.unknown().optional(),
    is_tpaction_aligned_2026: z.unknown().optional(),
...
export const RepresentativeSchema = z
  .object({
    ...
    websiteUrl: optionalStringish,
    website_url: optionalStringish,
    ballotpediaUrl: optionalStringish,
    ballotpedia_url: optionalStringish,
    citizensCountUrl: optionalStringish,
    citizens_count_url: optionalStringish,
