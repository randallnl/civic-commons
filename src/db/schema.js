...
export const people = sqliteTable(
  "d1_people",
  {
    ...
    ballotpediaUrl: text("ballotpedia_url"),
    citizensCountUrl: text("citizens_count_url"),
    stateHouseProfileUrl: text("state_house_profile_url"),
    ...
    isTpActionAligned2026: integer("is_tpaction_aligned_2026").notNull().default(0),
    isFreeStater: integer("is_free_stater").notNull().default(0),
    onlineTestimonyAlignmentPct: real("online_testimony_alignment_pct"),
    onlineTestimonyGrade: text("online_testimony_grade"),
    onlineTestimonyScoredVotes: integer("online_testimony_scored_votes"),
    onlineTestimonyAlignedVotes: integer("online_testimony_aligned_votes"),
    onlineTestimonyPartialVotes: integer("online_testimony_partial_votes"),
    onlineTestimonyMisalignedVotes: integer("online_testimony_misaligned_votes"),
    gradeUpdatedAt: text("grade_updated_at"),
...
export const personCandidateRoles = sqliteTable(
  "d1_person_candidate_roles",
  {
    ...
    winningMarginVotes: integer("winning_margin_votes"),
    seatsAvailable: integer("seats_available"),
    electionResultSource: text("election_result_source"),
